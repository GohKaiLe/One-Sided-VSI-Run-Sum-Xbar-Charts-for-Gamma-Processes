% ATS Optimisation for the Lower One-sided 4 Regions VSI Run Sum X-bar Chart %
...
for S1 = 0:1
    for S2 = S1:3
        for S3 = S2:5 
            for S4 = S3:10
                [hL, K] = FindhLKLowerVsiRSXbarGam(ATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale); 
...
disp('The optimal is:')
disp([hS, Opt_hL, delta, Opt_K, Opt_S1, Opt_S2, Opt_S3, Opt_S4, ATS0min, ASI0min, ATS1min, SDTS1min])
