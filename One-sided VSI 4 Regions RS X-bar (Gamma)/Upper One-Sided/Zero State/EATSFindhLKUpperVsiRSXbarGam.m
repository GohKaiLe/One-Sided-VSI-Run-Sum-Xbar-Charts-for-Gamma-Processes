% Create a function to find K and hL based on EATS %
% Upper One-sided VSI 4 Regions Run Sum X-bar Chart for Gamma %

function [hL, K] = EATSFindhLKUpperVsiRSXbarGam(EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale)
    ...
    obj_fun = @(x) ConstraintsEATS(x, EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale) ; 
