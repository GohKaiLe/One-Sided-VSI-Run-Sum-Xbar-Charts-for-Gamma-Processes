% AATS Optimization for the Upper One-sided 7 Regions VSI Run Sum X-bar Chart %
        ...
        for S3 = S2:4 
            for S4 = S3:6
                for S5 = S4:5
                    for S6 = S5: 8
                        for S7 = S6:10
                            [hL, K] = FindhLKUpperVsiRSXbarGamSteady(AATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale); 
