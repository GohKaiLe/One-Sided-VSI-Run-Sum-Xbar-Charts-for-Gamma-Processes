% ATS Optimization for the Upper One-sided 4 Regions VSI Run Sum X-bar Chart %
...
for S1 = 0:1
    for S2 = S1:3
        for S3 = S2:5 
            for S4 = S3:10
                [hL, K] = FindhLKUpperVsiRSXbarGam(ATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale); 
