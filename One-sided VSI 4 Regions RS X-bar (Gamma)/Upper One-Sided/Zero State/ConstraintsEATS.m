% Constranit for EATS optimisation %
% Upper One-sided VSI 4 Regions Run Sum Xbar Chart for Gamma %
% Zero State Case %

function ceq = ConstraintsEATS(x, EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale)
