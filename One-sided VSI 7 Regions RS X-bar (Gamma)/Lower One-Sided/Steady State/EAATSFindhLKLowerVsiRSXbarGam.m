% Create function to find hL and K based on EAATS %
% Lower One-sided VSI 7 Regions Run Sum X-bar Chart for Gamma %
% Steady State %

function [hL, K] = EAATSFindhLKLowerVsiRSXbarGam(EAATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale)
    ...
    obj_fun = @(x) ConstraintsEAATS(x, EAATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
