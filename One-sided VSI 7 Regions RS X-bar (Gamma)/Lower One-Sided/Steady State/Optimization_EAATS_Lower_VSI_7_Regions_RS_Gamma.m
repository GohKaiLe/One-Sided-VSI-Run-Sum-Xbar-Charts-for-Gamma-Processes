% EAATS-Optimal Parameters for VSI Lower One-sided 7 Regions RS X-bar Chart for Gamma %
% Steady State % 
        ...
        for S3 = S2:4 
            for S4 = S3:6
                for S5 = S4:5
                    for S6 = S5: 8
                        for S7 = S6:10
                            [hL, K] = EAATSFindhLKLowerVsiRSXbarGam(EAATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale); 
                            ...
                            if abs(EAATS0 - EAATS0_target) < 1 
                                EAATS = EAATSFindLowerGam(n, K, deltamin, deltamax, hS, hL, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
