...
function [hL, K] = FindhLKLowerVsiRSXbarGamSteady(AATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale)
    ...
    ub = [1.50, 2.5]; % Upper bounds for hL and K
