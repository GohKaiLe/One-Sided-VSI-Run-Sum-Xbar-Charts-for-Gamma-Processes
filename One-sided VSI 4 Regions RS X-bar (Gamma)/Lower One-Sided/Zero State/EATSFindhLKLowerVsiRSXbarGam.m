% Create a function to find hL and K based on EATS%
% Lower One-sided VSI 4 Regions Run Sum X-bar Chart for Gamma %
% Zero State %

function [hL, K] = EATSFindhLKLowerVsiRSXbarGam(EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale)
